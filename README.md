...
This checks registry structure, skill frontmatter, preset metadata, and the ten SVG assets. It does not validate a running DeepSeek Harness installation; use the harness's own preset mount check for that.
